var jsfiddle = (function($) {
    ...
    // url for x-domain .ajax jQuery plugin
    var xdomurl = 'https://raw.github.com/padolsey/jQuery-Plugins/master/cross-domain-ajax/jquery.xdomainajax.js';
        ...
        retrieve: function(user, options, success) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    // if we are successful then load the x-domain .ajax jQuery plug-in
                    $.getScript(xdomurl, function() {
